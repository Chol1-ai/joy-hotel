...
function defaultGallery() {
  return [
    ...
    },
    {
      ...
      category: 'rooms',
      description: 'Comfort and privacy in a refined executive setting',
      imageUrl: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?q=80&w=1200&auto=format&fit=crop',
    },
    {
      id: 'suite-3',
      title: 'Presidential View',
      category: 'rooms',
      description: 'Panoramic views and elegant furnishings',
      imageUrl: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?q=80&w=1200&auto=format&fit=crop',
    },
    {
      id: 'dining-1',
    ...
    },
    {
      ...
      category: 'dining',
      description: 'A bright, relaxing breakfast setting with fresh flavors',
    ...
    },
    {
      ...
      title: 'Chef’s Table',
      category: 'dining',
      description: 'A culinary experience featuring seasonal signature dishes',
    ...
    },
    {
      ...
      title: 'Massage Suite',
      category: 'spa',
      description: 'A calming environment designed for total relaxation',
    ...
    },
    {
      ...
      category: 'events',
      description: 'Grand celebrations with refined decor and music',
    ...
    },
    {
      ...
      category: 'events',
      description: 'Professional meetings and executive gatherings',
    ...
    },
    {
      ...
      title: 'Infinity Pool',
      category: 'amenities',
      description: 'A serene poolside retreat with skyline views',
